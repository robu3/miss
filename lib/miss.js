...
function Miss(connectionConfig) {
	var me = this;
	...
	me.executeQuery = function (query, parameters, isProcedure, cb) {
		executeQuery(me.connectionConfig, query, parameters, isProcedure, cb);
	};
	...
	me.map = function (query, parameters, isProcedure, keyColumns, mappers, cb) {
		executeQuery(me.connectionConfig, query, parameters, isProcedure,
			cb,
...
function executeQuery(sqlConfig, query, parameters, isProcedure, cb, rowHandler) {
	var conn = new tedious.Connection(sqlConfig),
		execQuery,
